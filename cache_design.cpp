...
void L2cache_read_request(cache_content L2cache[][32])
{
    L2_reads++;
    bool L2hit = false;
...
void L2cache_write_request(cache_content L1cache[][32], cache_content L2cache[][32], int evicted_block)
{
...
{   
    ...
    for (unsigned int set = 0; set < L1set; ++set) {
